...
def ben_graham_agent(state: AgentState, agent_id: str = "ben_graham_agent"):
    ...
    for ticker in tickers:
        ...
        metrics = _get_financial_metrics(ticker, end_date, period="annual", limit=10)

        progress.update_status(agent_id, ticker, "Gathering financial line items")
        financial_line_items = _search_line_items(ticker, ["earnings_per_share", "revenue", "net_income", "book_value_per_share", "total_assets", "total_liabilities", "current_assets", "current_liabilities", "dividends_and_other_cash_distributions", "outstanding_shares"], end_date, period="annual", limit=10)
