...
from src.tools.api import _get_financial_metrics, get_market_cap, _search_line_items, get_insider_trades, get_company_news
...
def charlie_munger_agent(state: AgentState, agent_id: str = "charlie_munger_agent"):
    ...
    for ticker in tickers:
        ...
        metrics = _get_financial_metrics(ticker, end_date, period="annual", limit=10)  # Munger looks at longer periods
